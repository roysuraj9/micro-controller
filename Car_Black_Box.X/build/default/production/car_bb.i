    ...
    if(i == 4)
    {
        ...
        else
        {
            ...
            if(attempts_rem == 0)
            {
                ...
                clcd_print("Wait for...  min", (0xC0 + 0));
                while(min)
                {
                    clcd_putch((min / 10) + '0', (0xC0 + 11));
                    clcd_putch((min % 10) + '0', (0xC0 + 12));
                }
                attempts_rem = 3;
...
void view_log(unsigned char key, unsigned char reset_flag)
{
    ...
    else
 {
  ...
  clcd_putch ( view[0] , (0xC0 + 2));
  clcd_putch ( view[1] , (0xC0 + 3));
  clcd_putch ( ':' , (0xC0 + 4));
  clcd_putch ( view[2] , (0xC0 + 5));
  clcd_putch ( view[3] , (0xC0 + 6));
  clcd_putch ( ':' , (0xC0 + 7));
  clcd_putch ( view[4] , (0xC0 + 8));
  clcd_putch ( view[5] , (0xC0 + 9));
  clcd_putch ( view[6] , (0xC0 + 11));
  clcd_putch ( view[7] , (0xC0 + 12));
  clcd_putch ( view[8] , (0xC0 + 14));
  clcd_putch ( view[9] , (0xC0 + 15));
 }
}
